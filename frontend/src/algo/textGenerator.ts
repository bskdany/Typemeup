import type { FingerStatistics } from "../interfaces";
import wordsFile from "../words/words.json";

export function generateWords(fingersStatistics: FingerStatistics[], fingerMap: string[][], reversedFingerMap: Map<string, number>, howManyWords: number) {
